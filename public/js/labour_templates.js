...
var userTable = $('#LabourTemplateTable').DataTable({
...
jQuery(function(){
    var m=document.getElementById('LabourTemplateModel'),table=document.getElementById('LabourTemplateTable');
    var locations = {
        init: function() {
            jQuery(document).on('click','.btn-submit',function(e){
                ...
                e.preventDefault();
                locations.fire(_this,"save");
            });
            jQuery(document).on('click','.fill_data',function(e){
                //jQuery('.pre-loader').show();
                var _this = jQuery(this);
                e.preventDefault();
                locations.fire(_this,"fetch");
            });
