...
var userTable = $('#GroupsTable').DataTable({
...
jQuery(function(){
    var m=document.getElementById('GroupModel'),table=document.getElementById('GroupsTable');
    var virtual_types = {
        init: function() {
            jQuery(document).on('click','.btn-submit',function(e){
                ...
                e.preventDefault();
                virtual_types.fire(_this,"save");
            });
            jQuery(document).on('click','.fill_data',function(e){
                //jQuery('.pre-loader').show();
                var _this = jQuery(this);
                e.preventDefault();
                virtual_types.fire(_this,"fetch");
            });
            jQuery(document).on('click',".btn-delete",function(e){
                ...
                if(confirm('Are you sure?')){
                    virtual_types.fire(_this,"delete");
                }
            });
