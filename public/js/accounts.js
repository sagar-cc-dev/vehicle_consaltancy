...
var userTable = $('#AccountsTable').DataTable({
...
jQuery(function(){
    var m=document.getElementById('AccountModel'),table=document.getElementById('AccountsTable');
    var operating_systems = {
        init: function() {
            jQuery(document).on('click','.btn-submit',function(e){
                ...
                e.preventDefault();
                operating_systems.fire(_this,"save");
            });
            jQuery(document).on('click','.fill_data',function(e){
                //jQuery('.pre-loader').show();
                var _this = jQuery(this);
                e.preventDefault();
                operating_systems.fire(_this,"fetch");
            });
            jQuery(document).on('click',".btn-delete",function(e){
                ...
                if(confirm('Are you sure?')){
                    operating_systems.fire(_this,"delete");
                }
            });
