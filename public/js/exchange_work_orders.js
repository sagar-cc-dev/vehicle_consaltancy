...
var userTable = $('#ExchangeWorkOrderTable').DataTable({
    ...
    columns: [
        {data: 'id', name: 'exchange_workorders.id',orderable: true,width:'4%'},
        {data: 'wo_num', name: 'exchange_workorders.wo_num',orderable: true},
        {data: 'exchange', name: 'exchange_workorders.exchange',orderable: true},
        {data: 'quantity', name: 'exchange_workorders.quantity',orderable: true},
        {data: 'salesgroup', name: 'sales_groups.salesgroup',orderable: true},
        {data: 'status', name: 'exchange_workorders.closed',orderable: true},
        {data: 'created_at', name: 'exchange_workorders.created_at',orderable: true},
