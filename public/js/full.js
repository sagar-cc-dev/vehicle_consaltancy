...
var userTable = $('#WorkOrderTable').DataTable({
    ...
    columns: [
        ...
        {data: 'status', name: 'workorder.closed',orderable: true},
        {data: 'commitement_new', name: 'workorder_timeline.commitement_new',orderable: true},
        {data: 'promise_new', name: 'workorder_timeline.promise_new',orderable: true},
        {data: 'in_yard', name: 'workorder_timeline.in_yard',orderable: true},
        {data: 'start_new', name: 'workorder_timeline.start_new',orderable: true},
        {data: 'completed_new', name: 'workorder_timeline.completed_new',orderable: true},
        {data: 'invoice_mailed_date', name: 'workorder_billing.invoice_mailed_date',orderable: true},
        {data: 'full_paid_new', name: 'workorder_billing.full_paid_new',orderable: true},
        {data: 'delivery_new', name: 'workorder_timeline.delivery_new',orderable: true},
