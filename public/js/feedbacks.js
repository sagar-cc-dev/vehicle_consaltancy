...
var userTable = $('#FeedbackTable').DataTable({
    ...
    columns: [
        ...
        {data: 'user', name: 'user',orderable: true,width:'4%'},
...
jQuery(function(){
    var m=document.getElementById('FeedbackModel'),table=document.getElementById('FeedbackTable');
    var rack_types = {
        init: function() {
