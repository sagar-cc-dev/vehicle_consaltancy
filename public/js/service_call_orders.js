...
var userTable = $('#ServiceCallOrderTable').DataTable({
    ...
    columns: [
        {data: 'id', name: 'service_call_orders.id',orderable: true,width:'4%'},
        {data: 'wo_num', name: 'service_call_orders.wo_num',orderable: true},
        {data: 'account_name', name: 'accounts.name',orderable: true},
        {data: 'location', name: 'categories.location',orderable: true},
        {data: 'model', name: 'service_call_orders.model',orderable: true},
        {data: 'position', name: 'service_call_orders.position',orderable: true},
        {data: 'requested_service', name: 'service_call_orders.requested_service',orderable: true},
        {data: 'estimated_time', name: 'service_call_orders.estimated_time',orderable: true},
        {data: 'closed', name: 'service_call_orders.closed',orderable: true},
        {data: 'created_at', name: 'service_call_orders.created_at',orderable: true},
