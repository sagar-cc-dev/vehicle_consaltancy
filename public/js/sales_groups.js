...
var userTable = $('#SalesGroupsTable').DataTable({
...
jQuery(function(){
    var m=document.getElementById('SalesGroupModel'),table=document.getElementById('SalesGroupsTable');
    var storage_types = {
        init: function() {
            jQuery(document).on('click','.btn-submit',function(e){
                ...
                e.preventDefault();
                storage_types.fire(_this,"save");
            });
            jQuery(document).on('click','.fill_data',function(e){
                //jQuery('.pre-loader').show();
                var _this = jQuery(this);
                e.preventDefault();
                storage_types.fire(_this,"fetch");
            });
            jQuery(document).on('click',".btn-delete",function(e){
                ...
                if(confirm('Are you sure?')){
                    storage_types.fire(_this,"delete");
                }
            });
